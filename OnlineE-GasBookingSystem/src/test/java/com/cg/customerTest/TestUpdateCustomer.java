...
public class TestUpdateCustomer {
	...
	public void beforeEach() {
		...
		Optional<Customer> optcust1 = Optional.of(new Customer(1, "rahim", "8574123690", "rahim64@gmail.com",
				"741258743699", "17 s k road, kolkata", "kolkata", "domestic"));
	...
	@Test
	@DisplayName(value = "test for update customer with invalid cylinder id")
	public void testUpdateCustomer3() throws CustomerNotFoundException, CylinderTypeMismatchException {
		CustomerDto customerDto = new CustomerDto("rahim", "8574123690", "rahim64@gmail.com", "741258743699",
				"17 s k road, kolkata", "kolkata", "aaa");
		assertThrows(CustomerNotFoundException.class, () -> customerService.updateCustomer(customerDto, 2));
